...
genes_of_interest <- c('ENSMUSG00000022982', 'ENSMUSG00000002985', 'ENSMUSG00000022551', 'ENSMUSG00000048756')
...
# Load the metadata containing tissue information
metadata_path <- "data/metadata/combined_metadata_dat.rds"
metadata <- readRDS(metadata_path)

metadata <- metadata %>% select(name, tissue)
